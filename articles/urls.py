...
from articles.views import ArticleCreate, article_delete, article_edit, article_search, article_view, delete_comment, edit_comment, post_comment, react_to_article, react_to_comment
...
urlpatterns = [
    ...
    path('<int:pk>/', include([
        ...
        path('edit/', article_edit, name='article_edit'),
